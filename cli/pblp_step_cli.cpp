...
int main() {
    std::string input_path =  "D:\\code\\PrimFit\\data\\output\\sculpt.pblp";
    ...
    pblp.optimize( para1, para2, para3, LinearProgramSolver::SCIP,  false);
...
//        c = easy3d::random_color();
    std::string out_path =  "D:\\code\\PrimFit\\data\\output2\\chamfer1.obj";
