...
int main(int argc, char **argv) {
    ...
    std::string out_seg_path;
    CLI::App app{"DEFILLET Command Line"};

    app.add_option("-i,--input", vg_path, ".vg file")->required();
    app.add_option("-o,--output", out_seg_path, ".seg file")->required();
    ...
    for(int i = 0; i < group_para.size(); i++) {
        ...
        PrimFit::SurfacePrimitive* sp = PrimFit::construct_bytype( PrimFit::SurfaceType::PLANE, para);
    ...
    PrimFit::Util::construct_std_from_SurfacePrimitive(shapes, type, pos, dir, r1, r2, colors);
    // std::string out_seg_path = "D:\\ICCV2023\\experiment\\E2\\peal\\points\\peal\\2023-03-04-145002\\peal.seg";
    PrimFit::IO::save_segment(out_seg_path, type, pos
                              , dir, r1, r2
