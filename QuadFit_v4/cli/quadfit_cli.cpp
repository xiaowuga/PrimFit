...
void merge_step(std::vector<int>& in_type, std::vector<easy3d::vec3>& in_pos
    ...
    for(int i = 0; i < num; i++) {
        ...
        out_r1[i] = para.r1;
        out_r2[i] = para.r2;
        out_type[i] = QuadFit::to_int_label(shapes_merged[i]->getType());
    }
...
void grow_step(int& step
    ...
    MatrixDr m_points;
    QuadFit::Util::construct_vertices_list_from_std_to_igl(m_points, in_points);
    QuadFit::Partition_Simplifier3 ps;
    ...
    for(int i = 0; i < num_face; i++) {
        ...
        m_face_color.row(i) = QuadFit::Util::construct_vertices_from_easy3d_to_igl(in_colors[label]);
    }
    int ct = 0;
...
int main() {
    std::string seg_path = "/Users/xiaowuga/Desktop/siggraph2023/00863903_0_10000.seg";
    ...
    igl::writeOBJ("/Users/xiaowuga/Desktop/siggraph2023/00863903_0_10000.obj", m_out_vertives, m_out_faces);
